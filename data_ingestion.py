...
This module provides functions for ingesting data from various sources, including databases and web URLs, and processing it into pandas DataFrames.

Functions:
- create_db_engine(db_path): Creates a SQLAlchemy database engine.
- query_data(engine, sql_query): Executes a SQL query on a database engine and returns the result as a DataFrame.
- read_from_web_CSV(URL): Reads a CSV file from a web URL and returns it as a DataFrame.
"""
...
def query_data(engine, sql_query):
    """
    Executes a SQL query on a database engine and returns the result as a DataFrame.
...
def read_from_web_CSV(URL):
    """
    Reads a CSV file from a web URL and returns it as a DataFrame.

    Args:
        URL (str): The URL of the CSV file.

    Returns:
        DataFrame: The CSV file contents as a pandas DataFrame.
